...
authRouter.post("/verify-email",  verifyEmailLimiter, authController.verifyEmailHandler);
authRouter.post("/resend-verification", authController.resendVerification);
authRouter.post("/refresh", authController.refresh);
authRouter.post("/forgot-password", forgotPasswordLimiter, authController.forgotPasswordHandler);
authRouter.post("/reset-password", passwordResetLimiter, authController.resetPasswordHandler);
